const AboutPage = () => {
  return (
    <div
      className="max-w-5xl mx-auto py-16 bg-gray-900
  "
    >
      {/* Intro Section */}

      <div className="flex flex-col md:flex-row items-center  md:items-start gap-10 mb-12 px-4">
        <img
      ...
      {/*Tech Stack */}
      <h2 className="text-2xl font-semibold text-white mb-4 px-4">🚀 Tech I Use</h2>
      <ul className="flex flex-wrap gap-4 text-sm text-gray-300 px-4">
        {[
          "React",
          "Next.js",
          "Vue",
